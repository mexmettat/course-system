...
void year2() {
    ...
    cout << " You have 38 credits.\n";
    cout << " You can choose elective courses if you have enough credits[10 Credits]." << endl << endl;
    ...
    cout << endl << "Select elective courses if you have enough credits [10 Credits] " << endl;
